...
import { getAllSpeakerApplications, getAllSpeakerNominations } from "@/lib/speakers-db-service"
import { ApplicationEntry, NominationEntry, SpeakerEntry } from "@/components/dashboard/types"
...
export default async function SpeakerDashboardPage() {
  ...
  const applications: ApplicationEntry[] = applicationsResult.success && applicationsResult.data 
  ...
  const nominations: NominationEntry[] = nominationsResult.success && nominationsResult.data
