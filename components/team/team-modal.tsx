...
import { Facebook, Twitter, Linkedin, Instagram, Globe, Mail } from "lucide-react"
            ...
            <div className="relative h-96 w-full md:h-full">
              ...
              <div className="absolute top-6 left-6 z-10">
                <div className={cn(
                  ...
                  member.role === "leadership" ? "bg-red-500/20 text-red-50 border border-red-500/30" :
                  member.role === "communications" ? "bg-blue-500/20 text-blue-50 border border-blue-500/30" :
                  member.role === "operations" ? "bg-amber-500/20 text-amber-50 border border-amber-500/30" :
                  member.role === "speakers" ? "bg-emerald-500/20 text-emerald-50 border border-emerald-500/30" :
                  member.role === "creative" ? "bg-purple-500/20 text-purple-50 border border-purple-500/30" :
                  member.role === "funding" ? "bg-teal-500/20 text-teal-50 border border-teal-500/30" :
                  member.role === "technical" ? "bg-indigo-500/20 text-indigo-50 border border-indigo-500/30" :
          ...
          <div className="relative flex-1 p-6 md:p-8 lg:p-10">
            ...
            <div className="custom-scrollbar max-h-[400px] overflow-y-auto pr-6 md:max-h-[540px]">
              ...
              <motion.div 
                ...
                className="mb-8"
              >
                <p className="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">About {member.firstName}</p>
