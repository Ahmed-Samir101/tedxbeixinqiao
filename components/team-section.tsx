        ...
        <div className="mx-auto max-w-7xl">
          <motion.div variants={itemVariants} className="mb-12 flex flex-col items-center text-center">
            ...
            <h2 className="mb-6 text-4xl font-bold text-black dark:text-white md:text-5xl">
              Meet the <span className="text-red-600 dark:text-red-500">People</span> Behind TEDxBeixinqiao
            </h2>
            <p className="mx-auto max-w-3xl text-lg text-gray-700 dark:text-gray-300">
              Our dedicated team brings together diverse talents and perspectives to create meaningful TEDx experiences that inspire and connect our community.
            </p>
          </motion.div>
                  ...
                  <div className="relative aspect-square bg-gray-200 dark:bg-gray-800">
                    ...
                    <div
                      className={cn(
                        ...
                        hoveredMember === member.name ? "opacity-100" : "opacity-70"
                      )}
                    ></div>
                  </div>
                  <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                    <div
                      className={cn(
                        ...
                        member.role === "leadership" ? "bg-red-600/80" :
                        member.role === "communications" ? "bg-blue-600/80" :
                        member.role === "operations" ? "bg-amber-600/80" :
                        member.role === "speakers" ? "bg-emerald-600/80" :
                        member.role === "technical" ? "bg-indigo-600/80" :
                        "bg-gray-600/80"
                      )}
                    >
