          ...
          <div className="relative flex-1 p-6 md:p-8 lg:p-10">
            ...
            <div className="custom-scrollbar max-h-[400px] overflow-y-auto pr-6 md:max-h-[540px]">
              ...
              >
                <div className="relative rounded-xl bg-gradient-to-br from-gray-50/80 to-gray-100/50 p-6 dark:from-gray-800/50 dark:to-gray-700/30">
                  <svg className="absolute left-4 top-4 h-8 w-8 text-red-300/30 dark:text-red-500/20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 8h10M7 12h10M7 16h4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
              ...
              <motion.div 
                ...
                className="mb-8"
              >
                <p className="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">About {speaker.name.split(' ')[0]}</p>
              ...
              <motion.div 
                ...
                className="mb-8"
              >
                <p className="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">About the talk</p>
                <div className="prose prose-lg max-w-none dark:prose-invert">
                  <p>
                    {speaker.description}
                  </p>
              ...
              {speaker.videoId && (
                ...
                >
                  <p className="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Watch the talk</p>
